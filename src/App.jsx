...
import PusatTemaSampul from './pages/PusatTemaSampul'
  ...
  return (
    <CartProvider>
      <Routes>
        ...
        {/* Halaman publik lain — TIDAK perlu login */}
        ...
        {/* Kuis Seru: game kuis untuk siswa kelas 1-3, tanpa login */}
        ...
        {/* Cetak Sampul Laporan & Hub Pusat Tema Sampul */}
        <Route path="/cetak-sampul" element={
          <ProtectedRoute adminOnly><CetakSampul /></ProtectedRoute>
        } />
        <Route path="/pusat-tema-sampul" element={
          <ProtectedRoute adminOnly><PusatTemaSampul /></ProtectedRoute>
        } />
