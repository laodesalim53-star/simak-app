  ...
  return [
    ...
    },
    {
      ...
      links: [
        ...
        // Manajemen Sekolah & Ujian 8355 hanya untuk superadmin.
        ...(isSuperAdmin
          ? [
              { to: '/manajemen-sekolah', label: 'Manajemen Sekolah', icon: Building2 },
              { to: '/data-ujian-8355', label: 'Data Ujian 8355', icon: FileSpreadsheet },
              { to: '/cetak-8355', label: 'Cetak 8355', icon: Printer },
            ]
          : []),
