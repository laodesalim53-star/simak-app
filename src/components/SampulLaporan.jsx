...
function SampulGelombang({ logoUrl, judulTampil, subJudul, labelTahun, tahunAnggaran, barisIdentitas, dibuatOleh }) {
  return (
    <div
...
function SampulGeometris({ logoUrl, judulTampil, subJudul, labelTahun, tahunAnggaran, barisIdentitas, dibuatOleh }) {
  return (
    <div
      className="lembar-cetak print-only bg-white mx-auto my-6 flex flex-col relative overflow-hidden"
      style={{ width: '210mm', height: '297mm', padding: '10mm' }}
...
function SampulAlam({ logoUrl, judulTampil, subJudul, labelTahun, tahunAnggaran, barisIdentitas, dibuatOleh }) {
  return (
    <div
...
function SampulBatik({ logoUrl, judulTampil, subJudul, labelTahun, tahunAnggaran, barisIdentitas, dibuatOleh }) {
  return (
    <div
      className="lembar-cetak print-only mx-auto my-6 flex flex-col relative overflow-hidden"
...
function SampulEmas({ logoUrl, judulTampil, subJudul, labelTahun, tahunAnggaran, barisIdentitas, dibuatOleh }) {
  return (
    <div
      className="lembar-cetak print-only mx-auto my-6 flex flex-col relative overflow-hidden"
...
function SampulKlasik({ logoUrl, judulTampil, subJudul, labelTahun, tahunAnggaran, barisIdentitas, dibuatOleh }) {
  return (
    <div
      className="lembar-cetak print-only bg-white mx-auto my-6 flex flex-col relative overflow-hidden"
      style={{ width: '210mm', height: '297mm', padding: '10mm' }}
...
export default function SampulLaporan({
  ...
  const propsSampul = { logoUrl, judulTampil, subJudul, labelTahun, tahunAnggaran, barisIdentitas, dibuatOleh }
