...
const daftarMateri = [
  ...
  {
    id: 'rktp-penyuluh-2',
    judul: 'RKTP Penyuluh 2',
    deskripsi: 'Rencana Kerja Tahunan Penyuluh Agama (RKTP): identitas, program, rencana bulanan, indikator kinerja, dan tanda tangan otomatis.',
    icon: CalendarCheck,
