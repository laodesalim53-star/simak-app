...
export default function PendaftaranNikah() {
  ...
  // Membuka dialog cetak browser. LembarCetakNikah selalu ada di DOM
  // (lihat komponen itu) dan disembunyikan lewat CSS @media print
  // murni — bukan lewat class Tailwind print: — jadi tidak bergantung
  // pada config Tailwind proyek Anda.
  ...
  return (
    <>
      ...
      {/* Lembar cetak — selalu di DOM, disembunyikan lewat CSS
          @media print di dalam LembarCetakNikah sendiri (bukan lewat
          class Tailwind print:), dan hanya tampil saat window.print(). */}
      <LembarCetakNikah data={data} />
    </>
  )
}
